 ...
 * @subpackage Retentiontab/public
 */
...
class Retentiontab_Public {
	...
	public function enqueue_scripts() {
		 ...
		 * class.
		 */
		$campaign = get_option('retentiontab_campaign');
		if (!isset($campaign) || empty($campaign)) {
			return;
		}

		wp_enqueue_script('rt', 'https://api.retentiontab.com/retentiontab2.js.php?campaign=' . $campaign, null, 1, true );
